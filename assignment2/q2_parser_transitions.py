...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        """
        if VERBOSE:
            print("stack: {}\nbuffer: {}\ndeps: {}".format(self.stack, self.buffer, self.dependencies))
        ...
        ### END YOUR CODE
        if VERBOSE:
            print("stack: {}\nbuffer: {}\ndeps: {}\n\n".format(self.stack, self.buffer, self.dependencies))
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while not len(unfinished_parses) == 0:
        l = min(len(unfinished_parses), batch_size)
        batch = unfinished_parses[:l]
